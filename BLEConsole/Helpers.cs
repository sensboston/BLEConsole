...
namespace BLEConsole
{
    ...
    public enum GattNativeCharacteristicUuid : ushort
    {
        ...
        CIE13_3­1995ColorRenderingIndex = 0x2AE7,
        ...
        IEEE11073­20601RegulatoryCertificationDataList = 0x2A2A,
        Illuminance = 0x2AFB,
        IncomingCall = 0x2BC1,
        ...
        MagneticFluxDensity­2D = 0x2AA0,
        MagneticFluxDensity­3D = 0x2AA1,
        ...
        Noise = 0x2BE4,
        Non­MethaneVolatileOrganicCompoundsConcentration = 0x2BD3,
        ObjectActionControlPoint = 0x2AC5,
        ObjectChanged = 0x2AC8,
        ObjectFirst­Created = 0x2AC1,
        ObjectID = 0x2AC3,
        ObjectLast­Modified = 0x2AC2,
        ...
        ParticulateMatter­PM1Concentration = 0x2BD5,
        ParticulateMatter­PM10Concentration = 0x2BD7,
        ParticulateMatter­PM2_5Concentration = 0x2BD6,
        ...
        PLXFeatures = 0x2A60,
        PLXSpot­CheckMeasurement = 0x2A5E,
        PnPID = 0x2A50,
